/**
 * Lens v2 core types — the data contract views render against.
 *
 * Pattern: Tree of nodes + typed event log, built incrementally from the
 *          agentfootprint v2 EventDispatcher stream.
 * Role:    The shape Lens recorder EXPOSES and Lens views CONSUME. Every
 *          framework (React today; Vue/Angular/CLI in the future)
 *          renders against the same types.
